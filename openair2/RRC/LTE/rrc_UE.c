    ...
    while(1)
    {
        ...
        switch(sl_ctrl_msg_recv->type)
        {
            ...
            case GROUP_COMMUNICATION_ESTABLISH_REQ:
                ...
                {
                    if((UE_rrc_inst[module_id].destinationList[i] == 0) && (j == 0))
                    {
                        j = i + 1;
                    }

                    if(UE_rrc_inst[module_id].destinationList[i] == groupL2Id)
                    {
                        break;    //group already exists!
                    }
                }

                if((i == MAX_NUM_DEST) && (j > 0))
                {
                    UE_mac_inst[module_id].destinationList[j - 1] = groupL2Id;
                }
            ...
            case DIRECT_COMMUNICATION_ESTABLISH_REQ:
                ...
                for(i = 0; i < MAX_NUM_DEST; i++)
                {
                    ...
                    if(UE_rrc_inst[module_id].destinationList[i] == destinationL2Id)
                    {
                ...
                if((i == MAX_NUM_DEST) && (j > 0))
                {
                    UE_mac_inst[module_id].destinationList[j - 1] = destinationL2Id;
                }
