...
int main(int argc, char **argv)
{
    ...
    if(verboselevel >= VERBOSE_LEVEL_MAIN_STEPS)
    {
        printf("Info: entering action #2 (Transfer .text section).\n");
    }
    ...
    if(verboselevel >= VERBOSE_LEVEL_MAIN_STEPS)
    {
        printf("Info: action #2 done.\n");
    }

    /* Action 3 : Find the .data section */
    if(verboselevel >= VERBOSE_LEVEL_MAIN_STEPS)
    {
        printf("Info: entering action #3 (Transfer .data section).\n");
    }
    ...
    if(verboselevel >= VERBOSE_LEVEL_MAIN_STEPS)
    {
        printf("Info: action #3 done.\n");
    }

    /* Action 4 : Find the .bss  section */
    if(verboselevel >= VERBOSE_LEVEL_MAIN_STEPS)
    {
        printf("Info: entering action #4 (Clear .bss section).\n");
    }
    ...
    if(verboselevel >= VERBOSE_LEVEL_MAIN_STEPS)
    {
        printf("Info: action #4 done.\n");
    }

    /* Action 5 : Find the entry address */
    if(verboselevel >= VERBOSE_LEVEL_MAIN_STEPS)
    {
        printf("Info: entering action #5 (Jump to firmware/set stack-pointer).\n");
    }
