...
int main(int n, char **v)
{
    ...
    out = fopen(output_file, "w"); if(out == NULL)
    {
        perror(output_file);
        exit(1);
    }
...
err:
    ...
    if(frame_arg == -1 || subframe_arg == -1 || buffer_arg == -1)
    {
        goto err;
    }
