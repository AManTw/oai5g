...
int main(int argc, char **argv)
{
    ...
    for(int k = 0; k < eNB->RU_list[0]->nb_rx; k++)
    {
        eNB->common_vars.rxdataF[k]     =  eNB->RU_list[0]->common.rxdataF[k];
    }
    ...
    for(int k = 0; k < NUMBER_OF_UE_MAX; k++)
    {
        eNB->ulsch[k] = new_eNB_ulsch(max_turbo_iterations, N_RB_DL, 0);
    }
    ...
    */
    ...
    if(cqi_flag == 1)
    {
        coded_bits_per_codeword -= UE->ulsch[0]->O;
    }
            ...
            for(trials = 0; trials < n_frames; trials++)
            {
                ...
                while(round < 4)
                {
                    ...
                    if(n_frames <= 10)
                    {
                        ...
                        {
                            LOG_M("rxsig1UL.m", "rxs1", &ru->common.rxdata[1][eNB->frame_parms.samples_per_tti * subframe], eNB->frame_parms.samples_per_tti, 1, 1);
                        }
                    }
